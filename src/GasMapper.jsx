...
export default function GasMapper()
{
  ...
  useEffect(() => {
    //CalculateTrip("219 prince albert st, centralia", "99 dundas st, london");
  }
  ,[]);
    ...
    return(<>
                <div>
                    ...
                    <p>The mapping feature utilizes geolocation technology to identify nearby gas stations and display them on an interactive map. Users can filter results based on price, distance, and brand preferences, making it easy to find the most convenient and cost-effective options. Gas station location data sourced from <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>. Routing data sourced from <a href="https://project-osrm.org/">Project OSRM</a> via coordinate lookup by <a href="https://nominatim.org/">Nominatim</a>.</p>
                </div>

                {/* Gets local gas prices */}
                <div className="GasCalculatorSection">
                    <GetGasPrices
                        mode={"gasCalculator"}
                    />
                </div>
